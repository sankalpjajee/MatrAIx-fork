...
function personaStatus(phase: PersonaEvalRunPhase, jobPhase: string, hasPersona: boolean): Pick<NodeState, "status" | "tone"> {
...
function chatbotStatus(phase: PersonaEvalRunPhase, jobPhase: string, turnCount: number): Pick<NodeState, "status" | "tone"> {
...
function scorerStatus(phase: PersonaEvalRunPhase, jobPhase: string, hasQuestionnaire: boolean): Pick<NodeState, "status" | "tone"> {

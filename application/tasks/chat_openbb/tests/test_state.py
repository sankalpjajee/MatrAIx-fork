...
def test_transcript_schema() -> None:
    ...
    if FEEDBACK_PATH.is_file():
        ...
        reason = (
            "The transcript captured a financial-research conversation, but there was "
            "no post-chat feedback artifact to confirm whether the persona found the "
            "analysis useful, grounded, or decision-supportive."
        )
    ...
    process_notes = (
        "The assistant asked follow-up questions before offering analysis, which makes "
        "the conversation comparable across personas on both effort and usefulness."
        if clarification_question_count > 0
        else "The conversation stayed direct, with little visible clarification before the analysis."
    )
        ...
        "contexts": [
            {
                ...
                "facets": [
                    ...
                    },
                    {
                        ...
                        "role": "evidence",
                        "kind": "textual",
                        "value": "Make useful progress on a concrete financial-research question",
                    },
                ],
            },
            {

# Pre-screening chatbot task 01: Digital Lifestyle Coaching for Adults With Type 2 Diabetes (DLC-T2D)
...
Condition: type 2 diabetes lifestyle coaching. All data is synthetic (ClinicalTrials.gov style) -
...
names one of the **17 labeled test cases** in `tests/ground_truth.json`
(4 eligible / 11 ineligible / 2 insufficient-information), the predicted label is additionally checked against the

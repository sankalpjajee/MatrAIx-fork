# Pre-screening chatbot task 10: Smart Inhaler Support for Uncontrolled Asthma (BREATHE-EASY)
...
Condition: smart inhaler for uncontrolled asthma. All data is synthetic (ClinicalTrials.gov style) -

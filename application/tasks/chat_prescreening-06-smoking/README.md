# Pre-screening chatbot task 06: App-Supported Quit Program With Nicotine Patch (QUIT-PATCH)
...
Condition: smoking cessation with nicotine patch. All data is synthetic (ClinicalTrials.gov style) -
